 ...
 *
 * <p>
 * Each signal corresponds to one button of the remote. We detected each signals
 * with the {@link IRSignalDetector}.</p>
 *
 * <p>
 * Sunfounder Media Remote:
 * <a href="http://raspoid.com/download/datasheet/SunfounderMediaRemote">Picture</a></p>
 *
...
public class IRProtocolSunfounderMediaRemote extends IRProtocol {
    ...
    public static final IRSignal button0 = new IRSignal("button_0",
            new int[]{0, 8520, 4300, 560, 540, 560, 560, 540, 560, 540,
                560, 560, 540, 560, 540, 560, 560, 540, 560, 560,
                1580, 540, 1600, 540, 1600, 540, 1600, 540, 1600, 540,
                1560, 560, 1580, 560, 1580, 560, 540, 560, 1580, 540,
                1600, 540, 560, 560, 1580, 540, 560, 560, 540, 560,
                560, 540, 1580, 560, 560, 540, 560, 520, 1620, 540,
                560, 560, 1580, 560, 1580, 560, 1580, 540, 37840, 8580, 2140, 540});
    ...
    /**
     * Constructor for the instantiation of a new Sunfounder Media Remote with
